...
?>
  ...
  <body>
		...
		<div class="container-fluid">
							...
							<form method="post" id="form">
								...
								<div class="form-row">
									<div class="col">
										...
										<input type="text" class="form-control" id="capacity" name="capacity" maxlength="50" placeholder="The number of available bookings per session">
									</div>
										<div class="col">
			...
			<!-- modal sign in-->
			<div class="modal fade" id="modal_sign_in" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
