    ...
    <script>
        $(document).ready(function () {
            ...
            $('#reset_forget_password').click(function () {
                ...
                var confirmation_code = $('#confirmation_code_forget_password').val();
            ...
            if (!isset($_SESSION["type"])) {
                ...
                <li class="nav-item">
                    <button type="button" id="sign_in" class="btn btn-xs"
                            style="background-color:#2F1F20; color:white;">Login
                    </button>
                </li>
                <li class="nav-item">
                    <button type="button" id="sign_up" class="btn btn-xs"
                            style="background-color:#2F1F20; color:white;">Sign Up
                    </button>
                </li>
            <?php } else {
                ?>
                ...
                <div class="modal-body">
                    ...
                    <form method="post" id="form">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="3" maxlength="300"
                                      placeholder="Explanation of facility"></textarea>
                        </div>
