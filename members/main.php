					...
					<div class="modal-content">
						...
						<form method="post" id="form">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="m_id" name="m_id" maxlength="50" placeholder="ID">
							</div>
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="tel" name="tel" maxlength="30" placeholder="Phone Number">
							</div>
